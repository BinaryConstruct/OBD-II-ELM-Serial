/*
 * ORIGINALLY WRITTEN BY Xasthom 
 * http://www.codeproject.com/KB/buttons/VistaButton.aspx
 * 
 * 7/01/2009
 * highly modified by Binary Construct
...
namespace OBDII_SerialTest
{
    ...
    public class VistaButton : System.Windows.Forms.UserControl
    {
        ...
        private Color mForeColorDisabled = Color.DarkGray;
        /// <summary>
        /// The color with which the text is drawn when control is disabled.
        /// </summary>
        [Category("Text"),
         Browsable(true),
         DefaultValue(typeof(Color), "DarkGray"),
         Description("The color with which the text is drawn when control is disabled.")]
        public Color ForeColorDisabled
        {
            get { return mForeColorDisabled; }
            set { mForeColorDisabled = value; this.Invalidate(); }
        }
        ...
        private void DrawGlow(Graphics g)
        {
            ...
            SetClip(g);
            int glowWidth = (int)(this.Width * 2);
            using (GraphicsPath glow = new GraphicsPath())
            {
                glow.AddEllipse(-(int)((glowWidth - this.Width) / 2 + 1), this.Height / 2 - 7, glowWidth, this.Height + 8);
        ...
        private void DrawText(Graphics g)
        {
            ...
            if (this.Enabled)
                ...
                g.DrawString(this.ButtonText, this.Font, new SolidBrush(this.ForeColorDisabled), r, sf);
        }
